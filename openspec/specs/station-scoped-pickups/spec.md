# station-scoped-pickups Specification

## Purpose
Cash-register orders allocate a distinct pickup code per production station, with independent ready and picked-up lifecycle so guests can collect one station while another is still cooking.
