# voucher-sales Specification

## Purpose
Define fixed-amount voucher sale lines as first-class order lines: creation from register and waiter, submission-time printing and printer routing, split settlement and collective assignment, and server-authoritative unit pricing.
