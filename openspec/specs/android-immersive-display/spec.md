# android-immersive-display Specification

## Purpose
Immersive system UI for kitchen / pickup / customer-display routes inside the Vendiqo Android WebView wrapper, including the JS bridge contract and Admin open/copy URL behavior on Android.
