...
class Organisation(Base):
    ...
    sumup_merchant_name = Column(String(255), nullable=True)
    sumup_merchant_sandbox = Column(Boolean, nullable=True)
    sumup_merchant_country = Column(String(2), nullable=True)
    ...
    first_event_setup_event_id = Column(Integer, nullable=True, index=True)
