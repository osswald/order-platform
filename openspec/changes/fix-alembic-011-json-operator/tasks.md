...
- [ ] 2.2 Re-run the guard test and related alembic/schema tests; confirm pass

## 3. Verify

- [ ] 3.1 Run cloud backend test suite (or at least migration + collective-bill reporting tests)
- [ ] 3.2 Run `./scripts/lint.sh --staged` (or full lint) before commit readiness
- [ ] 3.3 Mark OpenSpec tasks complete; note VPS apply/restart remains a separate operator step after merge/deploy
