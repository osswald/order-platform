# cloud-article-detail-save Specification

## Purpose
Cloud admin article detail Save behaves as one form action: persist article fields with applicable addition and ingredient links, stay on detail after success, and surface clear failures without claiming partial success.
