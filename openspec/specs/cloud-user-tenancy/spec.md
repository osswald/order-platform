# cloud-user-tenancy Specification

## Purpose

Home-Verleiher membership and role-scoped user visibility for cloud user management (platform / Verleiher / organisation admins).
