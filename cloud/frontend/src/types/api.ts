...
export type RentalRead = components['schemas']['RentalRead']
export type RentalZubehoerCatalogRead = components['schemas']['RentalZubehoerCatalogRead']
export type RentalZubehoerLineRead = components['schemas']['RentalZubehoerLineRead']
export type RentalCreate = components['schemas']['RentalCreate']
export type RentalUpdate = components['schemas']['RentalUpdate']
export type RentalAssignAppliance = components['schemas']['RentalAssignAppliance']
export type FleetRead = components['schemas']['FleetRead']
