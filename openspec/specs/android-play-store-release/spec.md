# android-play-store-release Specification

## Purpose
Define how the Vendiqo Waiter Android app is built, signed, and uploaded to Google Play as a single production APK with venue-LAN defaults.
