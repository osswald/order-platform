# pi-kitchen-monitor-routing Specification

## Purpose
Pi kitchen (and related fullscreen display) routes are bookmarkable/shareable: navigating to a monitor URL with valid bundle data lands on the monitor for the intended event, without first visiting Events or holding a waiter/register session.
