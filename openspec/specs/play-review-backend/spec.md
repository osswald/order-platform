...
- **WHEN** a client on the public internet requests `https://play-review.demo.vendiqo.ch/v1/health`
- **THEN** the request SHALL succeed with a healthy Pi backend response
