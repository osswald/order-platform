  ...
  <aside class="sidebar">
    <nav class="nav-menu">
      ...
      <div class="nav-section">
        ...
        <ul class="menu-items">
          <li>
            <RouterLink :to="routeTo('dashboard')" class="menu-item">
              <i class="icon pi pi-chart-line"></i>
              <span class="label">Dashboard</span>
            </RouterLink>
          </li>
          <li>
            <RouterLink :to="routeTo('events')" class="menu-item">
              <i class="icon pi pi-calendar"></i>
              <span class="label">Veranstaltungen</span>
            </RouterLink>
          </li>
          <li>
            <RouterLink :to="routeTo('waiters')" class="menu-item">
              <i class="icon pi pi-id-card"></i>
              <span class="label">Kellner</span>
            </RouterLink>
          </li>
          <li>
            <RouterLink :to="routeTo('articles')" class="menu-item">
              <i class="icon pi pi-tags"></i>
              <span class="label">Artikel</span>
            </RouterLink>
          </li>
          <li>
            <RouterLink :to="routeTo('article-categories')" class="menu-item">
              <i class="icon pi pi-folder"></i>
              <span class="label">Artikelkategorien</span>
            </RouterLink>
          </li>
          <li>
            <RouterLink :to="routeTo('appliance-lendings')" class="menu-item">
      ...
      <div class="nav-section">
        ...
        <ul class="menu-items">
          <li v-if="isAdmin">
            <RouterLink :to="routeTo('organisations')" class="menu-item">
              <i class="icon pi pi-building"></i>
              <span class="label">Organisationen</span>
            </RouterLink>
          </li>
          <li v-if="isAdmin">
            <RouterLink :to="routeTo('appliances')" class="menu-item">
              <i class="icon pi pi-desktop"></i>
              <span class="label">Geräte</span>
            </RouterLink>
          </li>
          <li v-if="isAdmin">
            <RouterLink :to="routeTo('users')" class="menu-item">
              <i class="icon pi pi-user"></i>
              <span class="label">Benutzer</span>
            </RouterLink>
          </li>
          <li>
            <RouterLink :to="routeTo('settings')" class="menu-item">
...
const emit = defineEmits(['change-organisation'])
