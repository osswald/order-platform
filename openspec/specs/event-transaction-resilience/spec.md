# event-transaction-resilience Specification

## Purpose
Defines how the cloud transaction-history API degrades safely when persisted edge order payloads contain malformed lines.
