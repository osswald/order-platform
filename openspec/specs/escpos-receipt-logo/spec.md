# escpos-receipt-logo Specification

## Purpose
Define how ESC/POS receipt logos are sized and placed for Bluetooth paper-width presets so rasters match printable dot widths and are not padded to an 80 mm printer profile.
