# event-article-price-overrides Specification

## Purpose

Sparse per-event sell-price overrides for catalogue articles (including additions), configured on the event Lager tab, emitted as effective prices in the edge catalogue bundle, and cloned on event copy.
